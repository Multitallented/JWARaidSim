...
export class BattlegroupComponent implements OnInit {
  ...
  squadMap: any = {};
  weaponMap: any = {};
  platoonOptions = new Array<Platoon>();
  armyList = new Array<Platoon>();
  frontSide = true;
  activePlatoon: Platoon;
  activeSquad: Squad;
  factionList: Array<Faction> = [];

  constructor(private armyListService:ArmyListService) { }
